(function() {
    ...
    var isOnGitHub, url = 'server/php/';

    var demoModule = angular.module('app-demo', [])

    demoModule.directive('agUpload', ['$rootScope',
        function($rootScope) {
            return {
                replace: true,
                restrict: 'E',
                link: function(scope, element, attrs) {
                    ...
                    var btnLable = attrs.btnLable ? attrs.btnLable : "图片上传";
                    var downloadUrl = '/aceesoryUpload/download.do';
                    ...
                    var uploadHtml = '';
                    uploadHtml = '<div class="fore-sys-file-btn">' + '<button type="button" flag="' + isEnabled + '"' + ' class="fore-sys-file-up-btn" value="">' + btnLable + '</button>' + '</div>';
                    var filters = attrs.extensions ? [{ title: "文档", extensions: attrs.extensions }] : [
                        { title: "所有文档", extensions: "*" }
                    ];

                    var html = '<div></div>' + uploadHtml + '<div class="fore-sys-file-list"><ul></ul></div>';
                    ...
                    function init_app() {
                        ...
                        uploader = WebUploader.create({
                            ...
                            chunked: false,
                            chunkSize: 512 * 1024,
                            server: 'http://localhost:8090/kz/picture/upload.do',
                            // runtimeOrder: 'flash',
